...
[Regular Expressions](https://pythonspot.com/regular-expressions/)  
[Python Regex: re.match(), re.search(), re.findall() with Example (guru99)](https://www.guru99.com/python-regular-expressions-complete-tutorial.html)  

## Networking  

[Network examples](https://pythonspot.com/network/)  

[JSON encoding](https://pythonspot.com/json-encoding-and-decoding-with-python/)  
